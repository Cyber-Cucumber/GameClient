...
public enum MovingDirection { LEFT, LEFT_up, UP_LEFT, UP_left, UP, UP_right, UP_RIGHT, RIGHT_up, RIGHT, RIGHT_down, DOWN_RIGHT, DOWM_right, DOWN, DOWN_left, DOWN_LEFT, LEFT_down }
