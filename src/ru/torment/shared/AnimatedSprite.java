...
public class AnimatedSprite extends Sprite {
	...
	/**
	 * Creates new <code>AnimatedSprite</code> with specified images and located at (0, 0).
	 * <p>
	 * 
	...
	/**
	 * Creates new <code>AnimatedSprite</code> with null image to specified location.
	 * <p>
	 * 
	...
	/**
	 * Creates new <code>AnimatedSprite</code> with null image and located at (0, 0).
	 * <p>
	 * 
	 * The sprite images must be set before rendering.
	 * 
